    ...
    <body class="antialiased font-outfit">
        <div class="bg-white">
            ...
            <div class="mt-4 md:mt-24 px-4 lg:px-24 md:grid md:grid-cols-2 md:gap-2">
                <div class="">
                    <img src="{{ asset('assets/img/convenience.jpg') }}" alt="" class="w-[38rem] h-[40rem] object-cover rounded-lg">
                </div>
                <div class="lg:my-auto md:max-w-lg flex flex-col justify-center md:block">
                    ...
                    <ul class="list-desc mb-8 space-y-4">
                        <li class="flex flex-col">
                            <h3 class="font-bold text-xl">Increased Visibility:</h3>
                        ...
                        <li class="flex flex-col">
                            <h3 class="font-bold text-xl">Expand Your Customer Base:</h3>
                            <span class="font-bold">
                    ...
                    <a href="https://restaurant.moboeats.com/register" class="bg-primary-one text-white px-6 py-4 rounded-lg text-center mt-2 lg:mt-20 font-semibold">Create you account here</a>
                </div>
            </div>
            ...
            <div class="mt-4 md:mt-24 px-4 lg:px-24 md:grid md:grid-cols-2 md:gap-2">
                <div class="lg:my-8 md:max-w-lg flex flex-col justify-center md:block">
                    ...
                    <ul class="list-desc mb-8 space-y-4">
                        <li class="flex flex-col">
                            <h3 class="font-bold text-xl">Flexible Ordering Options:</h3>
                            <span class="font-bold">
                        ...
                        <li class="flex flex-col">
                            <h3 class="font-bold text-xl">Multichannel Management:</h3>
                            <span class="font-bold">
                ...
                <div class="">
                    <img src="{{ asset('assets/img/personalized.jpg') }}" alt="" class="w-[38rem] h-[40rem] object-cover rounded-lg">
                </div>
            </div>

            <div class="bg-[#eae1e1bf] px-2 lg:px-24 pb-4">
                ...
                <div class="flex gap-4">
                    <div class="space-y-4 grid grid-col-2 gap-2">
                        <div class="block lg:flex gap-2">
                            <div class="basis-3/5">
                                <img src="{{ asset('assets/img/Sign Up.png') }}" alt="" class="w-[44rem] object-cover rounded-lg">
                            </div>
                            <div class="flex flex-col my-auto basis-2/5">
                                <span class="font-bold text-2xl">Sign Up</span>
                                <span class="font-bold">Joining Moboeats is quick and easy. Simply sign up your business and provide necessary business documents needed.</span>
                            </div>
                        </div>
                        <div class="block lg:flex gap-2 lg:gap-36">
                            <div class="flex flex-col my-auto basis-2/5 px-8">
                            ...
                            <div class="basis-3/5">
                                <img src="{{ asset('assets/img/Menu Management.png') }}" alt="" class="w-[44rem] object-cover rounded-lg">
                            </div>
                        </div>
                        <div class="block lg:flex gap-2">
                            <div class="basis-3/5">
                                <img src="{{ asset('assets/img/Order Management.png') }}" alt="" class="w-[44rem] object-cover rounded-lg">
                            </div>
                            <div class="flex flex-col my-auto basis-2/5">
                        ...
                        <div class="block lg:flex gap-2 lg:gap-36">
                            ...
                            <div class="basis-3/5">
                                <img src="{{ asset('assets/img/Multibranch Management.png') }}" alt="" class="w-[44rem] object-cover rounded-lg">
                            </div>
                        </div>
                        <div class="block lg:flex gap-2">
                            <div class="basis-3/5">
                                <img src="{{ asset('assets/img/Partner Dashboard.png') }}" alt="" class="w-[44rem] object-cover rounded-lg">
                            </div>
                            <div class="flex flex-col my-auto basis-2/5">
